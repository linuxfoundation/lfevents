...
function speakers_block_callback( $attributes, $content ) {
	...
	$out = '<section class="speakers-section wp-block-ugb-container alignfull" style="background: linear-gradient(90deg, ' . $bg_color_1 . ' 0%, ' . $bg_color_2 . ' 100%); color: ' . $text_color . ';"><h3 class="speakers-section-title">Featured Speakers</h3><ul class="speaker-list grid-x">';
