 ...
 * @version 1.9.4
 */
class CONBLOCKPRO_EDD_SL_Plugin_Updater {
	...
	private function get_update_transient_data() {
		...
		$limited_data->new_version = $version_info->new_version ?? null;
		$limited_data->tested = $version_info->tested ?? null;
		$limited_data->requires = $version_info->requires ?? null;
		$limited_data->requires_php = $version_info->requires_php ?? null;
