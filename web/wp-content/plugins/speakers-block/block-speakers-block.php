...
?>
	...
	<section class="speakers-section <?php echo $align; ?> <?php echo $classes; ?> <?php echo $color_mode; ?> <?php echo $text_color; ?>" <?php echo $inline_styles; ?>>
		...
		<ul class="speaker-list grid-x">
			...
			?>
				<li id="speaker-<?php echo $id; ?>" class="speaker cell small-6 medium-4 xxlarge-3" data-toggler=".open" style="background: linear-gradient(-45deg, transparent 30%, <?php echo $gradient_color; ?> 100%);">
					<div class="grid-x">
						<div class="cell large-5">
							<?php
							if (get_the_content()) {
							?>
								<div class="headshot" data-toggle="speaker-<?php echo $id; ?>">
								<?php
							} else {
								?>
									<div class="headshot">
								...
								<div class="text cell large-7">
									...
									if (get_the_content()) {
									?>
										<a class="name" data-toggle="speaker-<?php echo $id; ?>"><?php echo esc_html(get_the_title()); ?></a>
										<a class="title" data-toggle="speaker-<?php echo $id; ?>"><?php echo get_post_meta($id, 'lfes_speaker_title', true) ?></a>
									<?php
									} else {
									?>
									...
									<ul class="social-media-links">
										...
										if ($twitter) {
										?>
											<li><a href="<?php echo esc_url($twitter); ?>"><svg class="social-icon--twitter" style="fill:<?php echo $text_value; ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
										...
										if ($linkedin) {
										?>
											<li><a href="' . $linkedin . '"><svg class="social-icon--linkedin" style="fill:<?php echo $text_value; ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
										...
										if ($website) {
										?>
											<li><a href="' . $website . '"><svg class="social-icon--website" style="fill:<?php echo $text_value; ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
