...
- [Newsletter for China Site](#newsletter-for-china-site)
- Visa Request - *now available as Gutenberg block!*
- [Contact Us](#contact-us)
- [Kubecon Sponsor](#kubecon-sponsor)
- [Travel Fund Request](#travel-fund-request)
- Live Stream - *now available as Gutenberg block!*


## Newsletter for China Site
...
<form id="sfmc-form" action="https://cloud.email.thelinuxfoundation.org/CNCF-KubeCon-Newsletter-Form-China">
  ...
  <p>
  <input id="newsletter-english" type="radio" name="language" value="english" checked=""><label for="newsletter-english">English</label>
  <input id="newsletter-chinese" type="radio" name="language" value="chinese"><label for="newsletter-chinese">中文 Chinese</label>
  </p>
