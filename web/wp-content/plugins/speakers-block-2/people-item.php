			...
			<div class="person__social-margin">
				...
				<a  target="_blank" rel="noopener noreferrer"
					href="<?php echo esc_url( $linkedin ); ?>">
						<svg class="social-icon--linkedin" style="fill:<?php echo esc_html( $text_value ); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
				...
				if ( $twitter ) :
					?>
				<a target="_blank" rel="noopener noreferrer"
					href="<?php echo esc_url( $twitter ); ?>"><svg class="social-icon--twitter" style="fill:<?php echo esc_html( $text_value ); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="-24.52 -24.52 1248.04 1275.04">
				...
				if ( $github ) :
					?>
				<a target="_blank" rel="noopener noreferrer"
					href="<?php echo esc_url( $github ); ?>"><svg class="social-icon--github" style="fill:<?php echo esc_html( $text_value ); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="-1.95 -1.95 101.40 99.78">
				...
				if ( $website ) :
					?>
				<a target="_blank" rel="noopener noreferrer"
					href="<?php echo esc_url( $website ); ?>"><svg class="social-icon--website" style="fill:<?php echo esc_html( $text_value ); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
						...
						if ( $linkedin || $twitter || $github || $website ) :
							...
							<div class="person__social-margin">
								...
								if ( $linkedin ) :
									?>
								<a target="_blank" rel="noopener noreferrer"
									href="<?php echo esc_url( $linkedin ); ?>"><svg class="social-icon--linkedin" style="fill:<?php echo esc_html( $text_value ); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
																		<path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
																	</svg></a>
									<?php
							endif;
