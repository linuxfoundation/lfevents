...
<section class="benefits">
	...
	<div class="semantic">
		<img src="<?php echo get_stylesheet_directory_uri(); //phpcs:ignore ?>/dist/assets/images/demo/semantic.svg" alt="semantic">
		<h3>Semantic</h3>
		<p>Everything is semantic. You can have the cleanest markup without sacrificing the utility and speed of Foundation.</p>
	</div>

	<div class="responsive">
		<img src="<?php echo get_stylesheet_directory_uri(); //phpcs:ignore ?>/dist/assets/images/demo/responsive.svg" alt="responsive">
		<h3>Responsive</h3>
	...
	<div class="customizable">
		<img src="<?php echo get_stylesheet_directory_uri(); //phpcs:ignore ?>/dist/assets/images/demo/customizable.svg" alt="customizable">
		<h3>Customizable</h3>
	...
	<div class="professional">
		<img src="<?php echo get_stylesheet_directory_uri(); //phpcs:ignore ?>/dist/assets/images/demo/professional.svg" alt="professional">
		<h3>Professional</h3>
