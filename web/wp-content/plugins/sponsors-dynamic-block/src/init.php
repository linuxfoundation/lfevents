...
function sponsors_dynamic_block_callback( $attributes, $content ) {
	...
	$out = '<section class="sponsors-dynamic-section alignfull" style="background: linear-gradient(90deg, ' . $bg_color_1 . ' 0%, ' . $bg_color_2 . ' 100%); color: ' . $text_color . ';"><ul class="speaker-list grid-x">';
