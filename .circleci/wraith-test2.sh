...
if [ -z "$TERMINUS_SITE2" ] || [ -z "$TERMINUS_ENV" ]
then
  echo 'No test site specified. Set TERMINUS_SITE2 and TERMINUS_ENV.'
  exit 1
fi

echo "::::::::::::::::::::::::::::::::::::::::::::::::"
echo "Wraith test site: $TERMINUS_SITE2.$TERMINUS_ENV"
echo "::::::::::::::::::::::::::::::::::::::::::::::::"
echo
...
domains:
  current:  "http://live-lfasiallcci.pantheonsite.io"
  new:      "https://$TERMINUS_ENV-$TERMINUS_SITE2.pantheonsite.io"  
EOL
