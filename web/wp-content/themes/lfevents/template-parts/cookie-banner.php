...
<p id="cookie-banner"><?php echo esc_html( $cookies_text ); ?> <?php echo sprintf( '<a href="%s">%s</a>', esc_html( $cookies_link ), esc_html( $cookies_link_text ) ); ?><button id="cookie-banner-button" tabindex="0"
 role="button">
