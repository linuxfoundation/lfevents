	...
	<div class="grid-container xlarge-padding-bottom">
		<div class="grid-x grid-margin-x">
			<div class="cell medium-8 large-9 xlarge-margin-bottom">
				<div class="xlarge-margin-bottom no-margin-top wp-block-ugb-container ugb-container ugb--background-opacity-5 ugb--has-background ugb-container--height-short ugb-container--align-horizontal-full" style="background-color:#f1f1f1"><div class="ugb-container__wrapper"><div class="ugb-container__content-wrapper">
					<h4 class="medium-margin-bottom has-text-align-center">Sign up for the our newsletter to stay informed about upcoming events!</h4>
					<div class="lfevents-forms form-newsletter full-width">
						<div id="message"></div>
						<form id="sfmc-form" action="https://cloud.email.thelinuxfoundation.org/Submission---Dynamic-Newsletter-Form-Events">
							...
							<p class="text-tiny has-text-align-center no-margin-bottom">You may unsubscribe at any time. For more information please see our <a target="_blank" href="https://www.linuxfoundation.org/privacy/">Privacy Policy <?php echo esc_html( get_template_part( 'template-parts/svg/external-link' ) ); ?></a>.</p>
						</form>
					</div>
				</div></div></div>
				<?php
