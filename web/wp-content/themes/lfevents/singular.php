		...
		<main class="main-content-full-width">
			...
			while ( have_posts() ) :
				...
				if ( has_post_thumbnail() && $post->post_parent ) {
					...
					$subpage_header_style =  'color:' . $subpage_header_text_color . ';'
																	.'background-color: ' . $subpage_header_background_color . ';'
																	.'-webkit-text-fill-color: transparent;'
																	.'background: -webkit-gradient(linear,left top,right bottom,from(' . $menu_color_2 . '),to(' . $menu_color . '));'
																	.'background:      -o-gradient(linear,left top,right bottom,from(' . $menu_color_2 . '),to(' . $menu_color . '));'
