...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return arr_back; });
...
/*!*********************************************************!*\
  !*** ./node_modules/node-html-parser/dist/esm/index.js ***!
  \*********************************************************/
/*! exports provided: CommentNode, HTMLElement, parse, default, Node, TextNode, NodeType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CommentNode", function() { return _nodes_comment__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HTMLElement", function() { return _nodes_html__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "parse", function() { return _nodes_html__WEBPACK_IMPORTED_MODULE_1__["parse"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _nodes_html__WEBPACK_IMPORTED_MODULE_1__["parse"]; });

/* harmony import */ var _nodes_node__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./nodes/node */ "./node_modules/node-html-parser/dist/esm/nodes/node.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Node", function() { return _nodes_node__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _nodes_text__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./nodes/text */ "./node_modules/node-html-parser/dist/esm/nodes/text.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TextNode", function() { return _nodes_text__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _nodes_type__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./nodes/type */ "./node_modules/node-html-parser/dist/esm/nodes/type.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NodeType", function() { return _nodes_type__WEBPACK_IMPORTED_MODULE_4__["default"]; });
...
class CommentNode extends _node__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(rawText) {
        super();
         ...
         * @type {Number}
         */
        this.nodeType = _type__WEBPACK_IMPORTED_MODULE_1__["default"].COMMENT_NODE;
    }
    /**
 ...
 * @extends {Node}
 */
class HTMLElement extends _node__WEBPACK_IMPORTED_MODULE_1__["default"] {
    /**
    ...
    constructor(tagName, keyAttrs, rawAttrs = '', parentNode = null) {
         ...
         * Node Type declaration.
         */
        this.nodeType = _type__WEBPACK_IMPORTED_MODULE_2__["default"].ELEMENT_NODE;
     ...
     */
    get text() {
        return Object(he__WEBPACK_IMPORTED_MODULE_0__["decode"])(this.rawText);
    }
    /**
    ...
    querySelectorAll(selector) {
        ...
        return this.childNodes.reduce((res, cur) => {
            ...
            while (stack.length) {
                const state = Object(_back__WEBPACK_IMPORTED_MODULE_5__["default"])(stack); // get last element
                const el = state[0];
                if (state[1] === 0) {
                    // Seen for first time.
    ...
    querySelector(selector) {
        ...
        for (const node of this.childNodes) {
            ...
            while (stack.length) {
                const state = Object(_back__WEBPACK_IMPORTED_MODULE_5__["default"])(stack);
                const el = state[0];
                if (state[1] === 0) {
                    // Seen for first time.
                    if (el.nodeType !== _type__WEBPACK_IMPORTED_MODULE_2__["default"].ELEMENT_NODE) {
     ...
     */
    get lastChild() {
        return Object(_back__WEBPACK_IMPORTED_MODULE_5__["default"])(this.childNodes);
    }
    /**
     * Get attributes
    ...
    get attributes() {
        ...
        for (const key in attrs) {
            const val = attrs[key] || '';
            this._attrs[key] = Object(he__WEBPACK_IMPORTED_MODULE_0__["decode"])(val);
        }
        return this._attrs;
    }
    /**
    ...
    setAttribute(key, value) {
        ...
        if (this._attrs) {
            this._attrs[key] = Object(he__WEBPACK_IMPORTED_MODULE_0__["decode"])(attrs[key]);
        }
        // Update rawString
        this.rawAttrs = Object.keys(attrs).map((name) => {
            const val = JSON.stringify(attrs[name]);
...
function parse(data, options = { lowerCaseTagName: false, comment: false }) {
    ...
    while ((match = kMarkupPattern.exec(data))) {
        ...
        if (match[0][1] === '!') {
            ...
            if (options.comment) {
                ...
                currentParent.appendChild(new _comment__WEBPACK_IMPORTED_MODULE_6__["default"](text));
            }
            continue;
        }
        ...
        if (!match[1]) {
            ...
            if (!match[4] && kElementsClosedByOpening[tagName]) {
                if (kElementsClosedByOpening[tagName][match[2]]) {
                    stack.pop();
                    currentParent = Object(_back__WEBPACK_IMPORTED_MODULE_5__["default"])(stack);
                }
            }
    ...
    if (!options.noFix) {
        ...
        while (stack.length > 1) {
            ...
            const oneBefore = Object(_back__WEBPACK_IMPORTED_MODULE_5__["default"])(stack);
    ...
    const response = new _text__WEBPACK_IMPORTED_MODULE_3__["default"](data);
    response.valid = valid;
    return response;
}
 ...
 */
class TextNode extends _node__WEBPACK_IMPORTED_MODULE_1__["default"] {
    constructor(rawText) {
        super();
        this.rawText = rawText;
        /**
         ...
         * @type {Number}
         */
        this.nodeType = _type__WEBPACK_IMPORTED_MODULE_0__["default"].TEXT_NODE;
    }
    /**
     * Get unescaped text value of current node and its children.
     * @return {string} text content
...
/* harmony default export */ __webpack_exports__["default"] = (NodeType);
...
function Edit(_ref) {
  ...
  var tracks = attributes.tracks,
      ...
      showKeynote = attributes.showKeynote,
      keynoteText = attributes.keynoteText,
      keynoteLink = attributes.keynoteLink;
  var inspectorControls = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__["InspectorControls"], {
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('No. of tracks'),
    min: 1,
    max: 30,
    value: tracks,
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Min height of boxes'),
    min: 100,
    max: 800,
    step: 10,
    value: height,
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('CTA icon'),
    value: ctaIcon,
    options: [{
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Nothing'),
      value: ''
    }, {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Double Angle Right'),
      value: 'is-style-track-double-angle-right'
    }, {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('View Track'),
      value: 'view-track'
    }],
    onChange: function onChange(value) {
      return setAttributes({
  ...
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__["PanelBody"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__["RadioControl"], {
    label: "Text Color",
    selected: textColor,
    onChange: function onChange(value) {
      return setAttributes({
  ...
  var mainStyle = {
    '--track-height': height ? "".concat(height, "px") : '250px',
    '--track-color1': color1,
    '--track-color2': color2,
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, inspectorControls, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    style: mainStyle,
    className: "wp-block-lf-track-grid in-editor align".concat(align ? align : 'wide')
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("ul", {
    className: "track-wrapper columns-".concat(columns)
  }, Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["range"])(1, tracks).map(function (i) {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("li", {
      className: "track-box track-style box-".concat(i, " ").concat(className),
      key: i
      ...
      placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Track title')
    ...
    })), ctaIcon === 'view-track' && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
      className: "track-cta button transparent-outline"
    }, "View Track"), ctaIcon === 'is-style-track-double-angle-right' && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("h3", {
      className: "track-cta is-style-track-double-angle-right"
    }, ">>"));
  })), showKeynote && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
  ...
  }), ctaIcon && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("h3", {
    className: "track-cta is-style-track-double-angle-right"
  }, ">>"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("form", {
    className: "blocks-button__inline-link",
    onSubmit: function onSubmit(event) {
...
{
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["range"])(1, 30).forEach(function (i) {
    schema["title".concat(i)] = {
      source: 'html',
      selector: ".track-wrapper > *:nth-child(".concat(i, ") h4"),
      default: ''
    };
    schema["link".concat(i)] = {
      type: 'string',
      source: 'attribute',
      selector: ".track-wrapper > *:nth-child(".concat(i, ") a"),
      attribute: 'href',
      default: ''
    };
  });
}
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])('lf/track-grid', {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Track Grid'),
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('A linkable grid of tracks for an event. Currently set to max 30 tracks.'),
  category: 'common',
  icon: 'grid-view',
  keywords: [Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('track'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('grid'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('channels'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('event')],
  supports: {
    align: ['wide', 'full']
  },
  attributes: schema,
  styles: [{
    name: 'default',
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Custom Colours'),
    isDefault: true
  }, {
    name: 'event-gradient-color',
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Event Gradient')
  }],
  transforms: {
    from: [{
      type: 'block',
      ...
      transform: function transform(attributes) {
        ...
        var liChildren = Object(node_html_parser__WEBPACK_IMPORTED_MODULE_6__["parse"])(attributes.values); // setup empty object.

        var transformSchema = {}; // count the tracks.

        var tracks = liChildren.childNodes.length; // loop over each and setup an object.

        liChildren.childNodes.forEach(function (item, i) {
          var text = item.firstChild.childNodes[0].text;
          var link = item.firstChild.attributes.href;
          transformSchema["title".concat(i + 1)] = text;
          transformSchema["link".concat(i + 1)] = link;
        }); // sigh, there must be a better way to dump this in but I couldn't find it.

        return Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["createBlock"])('lf/track-grid', {
          tracks: tracks,
...
function save(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    style: mainStyle,
    className: "wp-block-lf-track-grid align".concat(align ? align : 'wide')
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ul", {
    className: "track-wrapper columns-".concat(columns)
  }, Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["range"])(1, tracks).map(function (i) {
    var title = attributes["title".concat(i)];
    var link = attributes["link".concat(i)];
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", {
      className: "track-box track-style box-".concat(i, " ").concat(className),
      key: i
    }, link && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("a", {
      className: "box-link",
      href: link
    }), !_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["RichText"].isEmpty(title) && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["RichText"].Content, {
      tagName: "h4",
      value: title
    }), ctaIcon === 'view-track' && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
      className: "track-cta button transparent-outline"
    }, "View Track"), ctaIcon === 'is-style-track-double-angle-right' && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h3", {
      className: "track-cta is-style-track-double-angle-right"
    }, ">>"));
  })), showKeynote && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "track-keynote track-style",
    style: mainStyle
  }, keynoteLink && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("a", {
    className: "box-link",
    href: keynoteLink
  }), !_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["RichText"].isEmpty(keynoteText) && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["RichText"].Content, {
    tagName: "h4",
    value: keynoteText
  }), ctaIcon && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h3", {
    className: "track-cta is-style-track-double-angle-right"
  }, ">>")));
}
