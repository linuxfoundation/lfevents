...
class LFEvents_Admin {
	...
	public function enqueue_editor_scripts() {
		wp_enqueue_script( $this->lfevents, plugin_dir_url( __FILE__ ) . 'js/lfevents-editor-only.js', array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-dom-ready', 'wp-data', 'jquery', 'wp-dom' ), $this->version, true );
	}
